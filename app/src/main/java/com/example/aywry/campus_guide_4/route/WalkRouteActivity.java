package com.example.aywry.campus_guide_4.route;
...
import com.example.aywry.campus_guide_4.uTil.AMapUtil;
...
public class WalkRouteActivity extends Activity implements OnMapClickListener,
    ...
    private LatLonPoint mStartPoint = Data.getStartPointInfo();
    private LatLonPoint mEndPoint = Data.getDestinationPointInfo();
